...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="applyleave.php?id=<?php echo $id?>"">MY LEAVE</a></li>
	...
	<div id="divimg">
	<div>
		    <h1 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;"><?php echo "$empName" ?></h1>
		    

			 

		    	<h2 style="font-family: 'Montserrat', sans-serif; font-size: 25px; text-align: center;">EMPLOYEE LEADER BOARD </h2>
    	<table>
